...
```base64```, ```watch```, ```blkid```, ```diff```, ```lsblk```, ```lsof```, ```nproc```, ```patch```, ```pkill```, ```pstree```, ```sha1sum```, ```sha256sum```, ```sha512sum```, ```tcping```, ```tree```, ```whoami```, ```ethtool```, ```nano```, ```iftop```, ```httping```, ```iperf3```, ```htop```, ```dmesg```, ```jq```, ```yq```, ```upx```, ```lscpu```, ```lslocks```, ```lsns```, ```lsusb```, ```...```
